...
<div class=" container-fluid">
    <div class="block-header">
        <h2>Dashboard</h2>
        <small class="text-muted">Welcome to e-Doctor</small>
    </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="tab-content" style="padding: 10px">
                    <div role="tabpanel" class="tab-pane animated flipInX active" id="home_animation_1"
                        ...
                        <h3>You are with us from  - <?php
                        $date=date_create($rspatient['admissiondate']." ".$rspatient['admissiontime']);
                        echo date_format($date,"F  d,  Y h:i A"); ?></h3>
                    </div>
                    <div role="tabpanel" class="tab-pane animated flipInX" id="profile_animation_1"
                        ...
                        <?php
                        $date=date_create($rspatient['appointmentdate']." ".$rspatient['appointmenttime']);
                        echo date_format($date,"F  d,  Y h:i A"); ?></h3>
