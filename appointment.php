...
else
{
   ...
   echo "</pre>";
   exit; */
   $sql ="INSERT INTO appointment(appointmenttype,patientid, departmentid, roomid,appointmentdate, appointmenttime, doctorid, status, app_reason) values('$_POST[select2]','$_POST[select4]','$_POST[select5]','$_POST[select5]','$_POST[appointmentdate]','$_POST[time]','$_POST[select6]','$_POST[select]','$_POST[appreason]')";
   if($qsql = mysqli_query($con,$sql))
   {
...
<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>Appointment Information 123</h2>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <select name="select7" id="select7" class=" form-control show-tick">
                                            ...
                                            <?php
                                                    /* $sqldoctor= "SELECT * FROM locations";
                                                    $qsqldoctor = mysqli_query($con,$sqldoctor);
                                                    while($rsdoctor = mysqli_fetch_array($qsqldoctor))
                                                    {
                                                        echo "<option value='$rsdoctor[location_id]' selected>$rsdoctor[location_name] ( $rsdoctor[city] ) </option>";
                                                    } */
                                                ?>
                                        </select>
                                    </div>
