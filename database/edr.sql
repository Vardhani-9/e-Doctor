...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2023 at 04:45 PM
...
(1, '', 1, 2, 2, '2023-02-03', '23:25:00', 3, 'Approved', 'back ache');
...
(1, 0, 0, '2023-02-02', '18:52:26', 0.00, 0.00, '', '00:00:00', '0000-00-00'),
(2, 1, 2, '2023-02-02', '18:56:30', 0.00, 0.00, '', '00:00:00', '0000-00-00'),
(3, 1, 1, '2023-02-02', '18:58:49', 0.00, 0.00, '', '00:00:00', '0000-00-00');
...
(1, 3, 3, 'Consultancy Charge', 1000.00, '2023-02-02', 'Active'),
(2, 3, 20, 'Treatment', 300.00, '2023-02-02', 'Active'),
(3, 3, 1, 'Prescription Charge', 300.00, '2023-02-02', 'Active');
...
(2, 'Orthopedics', 'Orthopedics', 'Active'),
(3, 'Obstetrics and Gynecology', 'Obstetrics and Gynecology', 'Active'),
(4, 'Dermatology', 'Dermatology', 'Active'),
(5, 'Pediatrics', 'Pediatrics', 'Active'),
(6, 'Radiology', 'Radiology', 'Active'),
(7, 'General Surgery', 'General Surgery', 'Active'),
(8, 'Ophthalmology', 'Ophthalmology', 'Active'),
(9, 'ENT', 'ENT', 'Active'),
(10, 'Andrologist', 'Andrologist', 'Active'),
(11, 'Urology', 'Urology', 'Active');
...
INSERT INTO `doctor` (`doctorid`, `doctorname`, `mobileno`, `departmentid`, `loginid`, `password`, `status`, `education`, `experience`, `consultancy_charge`, `doctor_rating`) VALUES
(1, 'Tamayo', '2125798361', 1, 'tamayo', '123456789', 'Active', 'MBBS', 7.0, 800.00, 5),
(2, 'Nanda', '123456789', 1, 'nanda', '123456789', 'Active', 'MBBS', 12.0, 1000.00, 4),
(3, 'Vinod', '123456789', 2, 'vinod', '123456789', 'Active', 'MBBS', 12.0, 1000.00, 4),
(4, 'Lova kumar', '123456789', 2, 'lovakumar', '123456789', 'Active', 'MBBS', 12.0, 900.00, 5);
...
INSERT INTO `doctor_location` (`doctor_location_id`, `doctor_id`, `location_id`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 2, 1),
...
(1, 'Guntupalli', 'Vijayawada'),
(2, 'Benz Circle', 'Vijayawada'),
(3, 'Tadepalli', 'Vijayawada'),
(4, 'Bhavanipuram', 'Vijayawada'),
(5, 'Tadepalli', 'Vijayawada');
...
(1, 'lova', '2023-02-02', '18:49:40', 'vj', '000000000000000', 'Vijayawada', 'jksjfsdkjf', 'lova', '123456789', '', 'Male', '1984-02-07', 'Active');
...
(1, 20, 1, 1, 3, 'X Ray', '554674785_4_caa2e08b75c34bdca223f321e592e896.png', '2023-02-02', '23:30:00', 'Active');
